<div class="col-lg-8 center mx-auto mt-4">
	<div class="card card-small mb-4 mt-5">
		<div class="card-header border-bottom d-flex justify-content-between">
			...
			<form method="get" action="<?php echo base_url('index.php/AdminController/add') ?>" style="margin-left: auto">
				...
				<div class="row" style="padding: 20px">
					<table class="table">
						...
						<tbody>
							...
							?>
									<tr>
										<td scope="row"><?php echo $row->oa_id;
										// print_r($row);
										?></td>
										<td>
											<a href="<?php echo base_url('physicians/userProfile/'.$row->user_account_id); ?>">
